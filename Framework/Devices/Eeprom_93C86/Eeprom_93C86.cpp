...
bool Eeprom_93C86::readData(ValueID id, uint8_t *buffer) {
...
bool Eeprom_93C86::writeData(ValueID id, uint8_t *buffer, uint8_t size) {
...
bool Eeprom_93C86::writeJournalEntry(JournalEntryType journalEntry) {
...
bool Eeprom_93C86::readJournalEntry(uint8_t entryNumber,
		JournalEntryType &journalEntry) {
...
bool Eeprom_93C86::isDataWritable(uint16_t dataSize) {
...
bool Eeprom_93C86::journalInfoIsValid(void) {
...
bool Eeprom_93C86::blockIsValid(uint8_t *buffer, uint8_t buffer_len) {
...
void Eeprom_93C86::writeJournalInfo(void) {
	JournalInfoType journalInfo;
